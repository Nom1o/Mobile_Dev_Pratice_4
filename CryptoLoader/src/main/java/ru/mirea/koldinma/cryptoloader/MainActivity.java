...
import ru.mirea.koldinma.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onCodeClick(View view) {
        ...
        bundle.putByteArray(MyLoader.ARG_TEXT, encryptMsg(binding.editText.getText().toString(),key));
